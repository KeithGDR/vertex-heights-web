...
';
	...
	$__finalCompiled .= '
	<article class="message  ' . ($__vars['post']['User']['is_staff'] ? 'message-staffPost' : '') . ' ' . (($__vars['post']['Thread']['user_id'] === $__vars['post']['user_id']) ? 'message-threadStarterPost' : '') . 'message--post js-post js-inlineModContainer ' . ($__vars['isIgnored'] ? 'is-ignored' : '') . ' ' . ($__templater->method($__vars['post'], 'isUnread', array()) ? ' is-unread' : '') . '"
