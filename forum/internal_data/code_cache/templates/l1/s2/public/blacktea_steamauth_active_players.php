...
<div class="block" data-xf-init="inline-mod" data-type="active_users" data-href="' . $__templater->func('link', array('inline-mod', ), true) . '">
						...
						<div class="structItem js-inlineModContainer">
							<div class="structItem-cell structItem-cell--icon">
								<div class="structItem-iconContainer">
									' . $__templater->func('avatar', array($__vars['users'][$__vars['userPlaytime']['user_id']], 's', false, array(
				))) . '
								</div>
							</div>
							<div class="structItem-cell structItem-cell--main" data-xf-init="touch-proxy">
								<a href="' . $__templater->func('link', array('members', $__vars['users'][$__vars['userPlaytime']['user_id']], ), true) . '" class="structItem-title">' . $__templater->escape($__vars['users'][$__vars['userPlaytime']['user_id']]['username']) . '</a>
							...
							<div class="structItem-cell structItem-cell--latest structItem-cell--meta">
								...
								<dl class="pairs pairs--justified structItem-minor">
									<dt>' . 'Updated' . '</dt>
									<dd>' . $__templater->func('date_dynamic', array($__vars['userPlaytime']['last_updated'], array(
				))) . '</dd>
								</dl>
							</div>
						</div>
