<?php
// FROM HASH: b3330d04dad7ae399c34f1853bd6f746
return array('macros' => array('user_info' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['user']['user_id']) {
		$__finalCompiled .= '
				';
		if ($__templater->func('can_display_steam_user_banner', array('before', ), false)) {
			$__finalCompiled .= '
	' . $__templater->func('steam_user_banner', array($__vars['user'], ), true) . '
';
		}
		$__finalCompiled .= '
';
...
';
	if ($__templater->func('can_display_steam_user_banner', array('after', ), false)) {
		$__finalCompiled .= '
	' . $__templater->func('steam_user_banner', array($__vars['user'], ), true) . '
';
	}
