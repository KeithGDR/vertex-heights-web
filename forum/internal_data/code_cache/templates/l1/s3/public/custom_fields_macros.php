<?php
// FROM HASH: 825dd891d4e6f9178f88c09d4f3f3658
	...
	if ($__templater->isTraversable($__compilerTemp1)) {
		...
		';
			...
			<dl class="' . $__templater->escape($__vars['valueClass']) . '">
				...
				<dd data-xf-init="tooltip" title="' . $__templater->filter($__templater->method($__vars['fieldDefinition'], 'getFormattedValue', array($__vars['set'][$__vars['fieldDefinition']['field_id']], )), array(array('strip_tags', array()),), true) . '">
