<?php
// FROM HASH: 96c1c944566f1df8fd5cedad6849ee52
return array('macros' => array('item' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
			<div class="structItem-title" uix-data-href="' . $__templater->func('link', array('threads' . (($__templater->method($__vars['thread'], 'isUnread', array()) AND (!$__vars['forceRead'])) ? '/unread' : ''), $__vars['thread'], ), true) . '">
				';
