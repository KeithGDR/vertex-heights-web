<?php
// FROM HASH: 886ba77f8ff2a1c54a118ff3f2c2b1f0
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Most active games');
...
<div class="block" data-xf-init="inline-mod" data-type="active_games" data-href="' . $__templater->func('link', array('inline-mod', ), true) . '">
	<div class="block-outer">
		' . $__templater->func('page_nav', array(array(
		'page' => $__vars['page'],
		'total' => $__vars['total'],
		'link' => 'steam/active-games',
	...
	if (!$__templater->test($__vars['games'], 'empty', array())) {
		...
		$__finalCompiled .= '
				<div class="block-row">' . 'There are no active games to display.' . '</div>
			';
	}
	$__finalCompiled .= '
		</div>
