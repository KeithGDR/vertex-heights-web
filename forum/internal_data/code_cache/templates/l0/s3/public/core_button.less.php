<?php
// FROM HASH: 46bb7095cc722a5825fe944ab216500f
...
a.button // needed for specificity over a:link
{
	...
	&.button--icon
	{
		...
		*/
		...
		&--edit	{ 
			.m-buttonIcon(@fa-var-pencil, 0.86em); // fa-pencil
			> .button-text:before {' . $__templater->callMacro('uix_icons.less', 'content', array(
		'icon' => 'edit',
	), $__vars) . '} 
		}
		...
		&--reply { 
			.m-buttonIcon(@fa-var-mail-reply, 1em); // fa-reply
			> .button-text:before {' . $__templater->callMacro('uix_icons.less', 'content', array(
		'icon' => 'reply',
	), $__vars) . '} 
		}
		...
		&--delete, &--undelete { 
			.m-buttonIcon(@fa-var-trash-o, .79em); 
			> .button-text:before {' . $__templater->callMacro('uix_icons.less', 'content', array(
		'icon' => 'delete',
	), $__vars) . '}
		}
