<?php
// FROM HASH: 4781a82054764da1669a1dc6c6f1dce4
...
';
	...
	$__finalCompiled .= '
	<article class="message  ' . ($__vars['post']['User']['is_staff'] ? 'message-staffPost' : '') . ' ' . (($__vars['post']['Thread']['user_id'] === $__vars['post']['user_id']) ? 'message-threadStarterPost' : '') . 'message--post ' . ($__vars['uix_condensed'] ? 'uix_message--condensed' : '') . ' js-post js-inlineModContainer ' . ($__vars['isIgnored'] ? 'is-ignored' : '') . ' ' . ($__templater->method($__vars['post'], 'isUnread', array()) ? ' is-unread' : '') . '"
		...
		'threadUserId' => $__vars['thread']['User']['user_id'],
