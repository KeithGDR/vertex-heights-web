	...
	if ($__templater->method($__vars['property'], 'isValidCssComponent', array('background', ))) {
		$__finalCompiled .= '
			...
			'dir' => 'ltr',
							...
							<tr>
								<td>';
		if ($__templater->method($__vars['xf']['visitor'], 'hasAdminPermission', array('uploadSPImages', ))) {
			$__finalCompiled .= '
	' . $__templater->includeTemplate('th_uix_uploadable_background_property', $__vars) . '
	';
		} else {
			$__finalCompiled .= '
	' . $__templater->formTextBox(array(
