...
');
	$__finalCompiled .= '
';
	if ((!$__vars['items']) OR $__templater->func('empty', array($__vars['items']))) {
		$__finalCompiled .= '
...
';
	...
	';
		...
		if ($__templater->isTraversable($__vars['items'])) {
			foreach ($__vars['items'] AS $__vars['item']) {
				$__compilerTemp1 .= '
					...
					'href' => $__templater->func('link', array('users/edit', $__vars['item'], ), false),
					'_type' => 'cell',
					'html' => '
								' . $__templater->func('avatar', array($__vars['item'], 's', false, array(
					'href' => '',
				))) . '
							',
				),
		...
		<div class="block-outer">
			...
			'key' => 'items',
			'ajax' => $__templater->func('link', array('steam/list', null, array('criteria' => $__vars['criteria'], ), ), false),
