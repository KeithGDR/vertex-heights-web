...
';
	$__templater->modifySidebarHtml('_xfWidgetPositionSidebarThtrendingTrendingSidebar', $__templater->widgetPosition('thtrending_trending_sidebar', array()), 'replace');
	$__finalCompiled .= '
';
	$__templater->modifySideNavHtml('_xfWidgetPositionSideNavThtrendingTrendingSidenav', $__templater->widgetPosition('thtrending_trending_sidenav', array()), 'replace');
	$__finalCompiled .= '
';
