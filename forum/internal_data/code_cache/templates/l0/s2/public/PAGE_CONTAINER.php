<?php
// FROM HASH: f48c24d629e5a43fae66eee9c7be4e19
return array('macros' => array('uix_sidebarTrigger__component' => function($__templater, array $__arguments, array $__vars)
{
...
'uix_mainTabComponent' => function($__templater, array $__arguments, array $__vars)
{
	$__vars = $__templater->setupBaseParamsForMacro($__vars, false);
	$__finalCompiled = '';
	$__vars = $__templater->mergeMacroArguments(array(
...
'uix_footer' => function($__templater, array $__arguments, array $__vars)
{
	$__vars = $__templater->setupBaseParamsForMacro($__vars, false);
	$__finalCompiled = '';
	$__vars = $__templater->mergeMacroArguments(array(
...
'uix_logoBlock' => function($__templater, array $__arguments, array $__vars)
{
	$__vars = $__templater->setupBaseParamsForMacro($__vars, false);
	$__finalCompiled = '';
	$__vars = $__templater->mergeMacroArguments(array(
...
'canvasNavPanel' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['xf']['visitor']['user_id']) {
		$__finalCompiled .= '
								...
								<div class="offCanvasMenu-linkHolder u-ripple ' . (($__vars['uix_myAccountLinks'] == 'alerts') ? 'is-selected' : '') . '"><div class="p-navEl__inner"><a data-nav-id="alerts" href="' . $__templater->func('link', array('account/alerts', ), true) . '" class="offCanvasMenu-link">' . 'Alerts' . '</a></div></div>
...
'nav_entry' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['sidebarNav'] AND ($__vars['nav']['children'] AND $__templater->func('property', array('uix_tablinksInSideNav', ), false))) {
		...
		$__finalCompiled .= '">' . $__templater->fontAwesome('fa-chevron-down', array(
...
';
	...
	if ($__vars['sidebar']) {
		...
		if ($__templater->func('property', array('uix_collapsibleSidebar', ), false) AND $__vars['uix_canCollapseSidebar']) {
			$__compilerTemp1 .= '
			<a class="uix_sidebarTrigger__component uix_sidebarTrigger ' . (($__templater->func('property', array('uix_sidebarTriggerPosition', ), false) == 'sectionLinks') ? 'p-navgroup-link' : 'button') . '" data-xf-init="tooltip" title="' . 'Sidebar' . '">
...
';
	...
	if ($__vars['template'] != 'login') {
		...
		if ($__templater->func('property', array('uix_loginStyle', ), false) == 'dropdown') {
			$__compilerTemp5 .= '
			<a href="' . $__templater->func('link', array('login', ), true) . '" class="button p-navgroup-link p-navgroup-link--textual p-navgroup-link--logIn" data-xf-click="menu">
				<i></i>
		...
		';
			...
			$__compilerTemp5 .= '
			<a href="' . $__templater->func('link', array('login', ), true) . '" class="button p-navgroup-link u-ripple p-navgroup-link--textual p-navgroup-link--logIn" data-xf-click="overlay" data-follow-redirects="on">
				<i></i>
				<span class="p-navgroup-linkText">' . 'Log in' . '</span>
			</a>
		';
			...
			$__compilerTemp5 .= '
			<a href="' . $__templater->func('link', array('login', ), true) . '" class="button p-navgroup-link u-ripple p-navgroup-link--textual p-navgroup-link--logIn" data-follow-redirects="on">
				<i></i>
				<span class="p-navgroup-linkText">' . 'Log in' . '</span>
			</a>
		';
			...
			$__compilerTemp5 .= '
			<a href="' . $__templater->func('link', array('login', ), true) . '" id="uix_loginPanel--trigger" class="button p-navgroup-link u-ripple p-navgroup-link--textual p-navgroup-link--logIn" rel="nofollow" data-follow-redirects="on">
				<i></i>
				<span class="p-navgroup-linkText">' . 'Log in' . '</span>
			</a>
		';
	...
	if ($__vars['template'] != 'register_form') {
		...
		if ($__templater->func('property', array('uix_loginStyle', ), false) != 'link') {
			$__compilerTemp6 .= '
			<a href="' . $__templater->func('link', array('register', ), true) . '" class="button button--primary p-navgroup-link u-ripple p-navgroup-link--textual p-navgroup-link--register" data-xf-click="overlay" data-follow-redirects="on">
				<i></i>
		...
		';
			...
			$__compilerTemp6 .= '
			<a href="' . $__templater->func('link', array('register', ), true) . '" class="button button--primary p-navgroup-link u-ripple p-navgroup-link--textual p-navgroup-link--register" data-follow-redirects="on">
				<i></i>
				<span class="p-navgroup-linkText">' . 'Register' . '</span>
			</a>
		';
	...
	if ($__vars['xf']['visitor']['user_id']) {
		$__compilerTemp30 .= '
					<ul class="uix_sidebarNavList">
						...
						<li><div class="p-navEl u-ripple ' . (($__vars['uix_myAccountLinks'] == 'alerts') ? 'is-selected' : '') . '"><div class="p-navEl__inner"><a data-nav-id="alerts" href="' . $__templater->func('link', array('account/alerts', ), true) . '" class="p-navEl-link">' . 'Alerts' . '</a></div></div></li>
...
';
	...
	if (($__templater->func('property', array('uix_pageWidthToggle', ), false) != 'disabled') AND $__vars['uix_canTogglePageWidth']) {
		$__compilerTemp45 .= '
										<li><a id="uix_widthToggle--trigger" data-xf-init="tooltip" title="' . 'Toggle width' . '" >' . $__templater->fontAwesome('fa-compress-alt', array(
